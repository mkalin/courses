...
int swap_bitwise(int* ptr, int swap_value) {
  *ptr = *ptr ^ swap_value;
  swap_value = *ptr ^ swap_value;
  *ptr = *ptr ^ swap_value;
  return swap_value;
}

int swap_arithmetic(int* ptr, int swap_value) {
  *ptr = *ptr + swap_value;
  swap_value = *ptr - swap_value;
  *ptr = *ptr + swap_value;
  return swap_value;
...
int main() {
  ...
  n1 = 7;
  n2 = swap_bitwise(&n1, -999);
  printf("n1 == %d and n2 == %d\n", n1, n2);

  n1 = 7;
  n2 = swap_arithmetic(&n1, -999);
  printf("n1 == %d and n2 == %d\n", n1, n2);
